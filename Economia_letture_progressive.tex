...
% =================================================================
% INIZIO LETTURA 05 - circa 890 parole di testo
...
\subsection*{Esternalità e sottoinvestimento}

Un bene pubblico produce benefici anche per persone che non hanno contribuito direttamente al suo finanziamento. Quando una strada viene illuminata, per esempio, la luce è utile a tutti coloro che passano: residenti, lavoratori, clienti dei negozi e persone che attraversano il quartiere.

Il beneficio non riguarda quindi soltanto chi ha pagato per installare le lampade. Si estende anche ad altre persone. In economia, questo effetto favorevole sulla collettività viene chiamato \textbf{esternalità positiva}.

Un'impresa privata decide quanto investire osservando soprattutto i ricavi che può ottenere. Nel caso dell'illuminazione stradale, però, è difficile chiedere un pagamento a ogni persona che utilizza la luce. Molti beneficiari possono usufruire del servizio senza pagare. L'impresa non riesce quindi a trasformare tutti i benefici prodotti in ricavi.

Per questa ragione l'investimento privato può essere inferiore a quello utile per la collettività. Questo problema viene chiamato \textbf{sottoinvestimento}: il bene produce un grande beneficio complessivo, ma chi dovrebbe finanziarlo privatamente non può recuperare tutti i costi attraverso i pagamenti degli utilizzatori.

Lo Stato può intervenire raccogliendo risorse attraverso le imposte e finanziando il bene pubblico. Può produrre direttamente il servizio oppure affidarne la realizzazione a un'impresa. In entrambi i casi, lo Stato considera il beneficio per l'intera collettività e distribuisce il costo tra molti cittadini.

L'intervento pubblico non elimina la necessità di scegliere. Le risorse dello Stato sono limitate e devono essere distribuite tra progetti diversi. Bisogna quindi confrontare il costo del bene pubblico con i benefici che può offrire alla collettività.
...
\item Che cosa significa esternalità positiva nel caso di un bene pubblico?

\item Perché lo Stato può ridurre il problema del sottoinvestimento?
